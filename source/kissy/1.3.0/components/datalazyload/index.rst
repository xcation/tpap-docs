...
-----------------------------------------------
    ...
    **三个简单的demo例子**
    ...
    .. raw:: html
        ...
        <iframe width="100%" height="560"  class="iframe-demo" src="http://tpap-docs.taegrid.taobao.com/kissy/1.3.0/component/datalazyload/datalazyload.php"></iframe>

    **对应DEMO html/php的代码**

    .. literalinclude:: /raw/tpap/kissy/1.3.0/component/datalazyload/datalazyload.php
        :language: html

    **对应DEMO javascript的代码**

    .. literalinclude:: /raw/tpap/kissy/1.3.0/component/datalazyload/datalazyload.js
        :language: javascript


    **对应DEMO css的代码**

    .. literalinclude:: /raw/tpap/kissy/1.3.0/component/datalazyload/datalazyload.css
        :language: css
